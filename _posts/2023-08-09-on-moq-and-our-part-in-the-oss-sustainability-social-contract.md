...
* **[Concerns were raised](https://github.com/devlooped/SponsorLink/issues/10) but the developer didn't care**: I'm not sure I see it the same way. I think someone had an idea for how to maybe address the OSS sustainability crisis within their own sphere of influence and the optimism outweighed the downsides (plus a lack of understanding of the GDPR implications).
